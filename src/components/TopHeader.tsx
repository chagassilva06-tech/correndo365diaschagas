...
export function TopHeader() {
  return (
    <header className="fixed left-0 right-0 top-0 z-50 h-16 border-b border-white/5 bg-[#00021b] px-6 shadow-[0_8px_30px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.08),inset_0_-2px_6px_rgba(0,0,0,0.4)]">
